...
type Players struct {
	...
	PlayerDeaths []PlayerDeaths `gorm:"foreignKey:PlayersID;references:ID" json:"deaths"`
	PlayerItems  []PlayerItem   `gorm:"foreignKey:PlayersID;references:ID" json:"items"`
}

type PlayerItem struct {
	PlayersID  int    `gorm:"column:player_id;primaryKey"`
